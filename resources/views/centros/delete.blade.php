        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Eliminar {{$centro->centro_nombre}}</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="alert alert-warning">
                    <i class="fa fa-info-circle"></i> Si elimina este Centro, se eliminarán en cascada las Aulas relacionadas así como la asociación de profesores, los alumnos con sus registros diarios y sus respectivos tutores.
                </div>
            </div>
        </div>
        <div class="row mb-3 mt-2 text-center">
            <div class="col-lg-12">
            <form action="/eliminar/centro/{{ $centro->id }}" method="POST">
                @csrf
