...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">        
            ...
            <div class="row mt-4">       
                <div class="col-lg-12 col-md-12">
                  <h1>Director Centro</h1> 
                </div>      
                <div class="col-lg-12 col-md-12">
                <table id="lista_director" class="table table-bordered table-striped">
                    <thead>
                    <tr>
                    <th>Nombre</th>
                    <th>Acciones</th>
                    ...
                    <tbody>
                        <tr>
                            <td>{{$director->name}} {{$director->username1}} {{$director->username2}}</td>
                           
                            <td>
                                <div class="d-flex justify-content-around">
                                  <a href="/mensajes/tutor/director/{{$director->id}}" class=""><i class="fa fa-envelope"></i></a>&nbsp;                                  
                                  </div>
                            </td>
                        </tr>
                    </tbody>
